...
T = TypeVar("T", bound="PurchaseCargo201ResponseData")
...
class PurchaseCargo201ResponseData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        purchase_cargo_201_response_data = cls(
            agent=agent,
            cargo=cargo,
            transaction=transaction,
        )

        purchase_cargo_201_response_data.additional_properties = d
        return purchase_cargo_201_response_data
